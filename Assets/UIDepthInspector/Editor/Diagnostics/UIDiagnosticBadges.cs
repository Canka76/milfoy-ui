...
namespace UIDepthInspector.Editor.Diagnostics
{
    ...
    public static class UIDiagnosticBadges
    {
        public static Color GetBadgeColor(DiagnosticFlags flags)
        {
            ...
            if ((flags & (DiagnosticFlags.GhostBlocker | DiagnosticFlags.OcclusionBlocker)) != 0)
        ...
        {
            bool isWarning = (flags & (DiagnosticFlags.GhostBlocker | DiagnosticFlags.OcclusionBlocker)) != 0;
            dot.EnableInClassList("stack-dot--inactive", (flags & DiagnosticFlags.Inactive) != 0);
            dot.EnableInClassList("stack-dot--ghost", (flags & DiagnosticFlags.Inactive) == 0 && isWarning);
            dot.EnableInClassList("stack-dot--raycast", (flags & DiagnosticFlags.Inactive) == 0 && !isWarning && (flags & DiagnosticFlags.RaycastBlocker) != 0);
            dot.EnableInClassList("stack-dot--passive", (flags & DiagnosticFlags.Inactive) == 0 && !isWarning && (flags & DiagnosticFlags.RaycastBlocker) == 0);
        }
        ...
        public static Label CreateOcclusionBadge()
        {
            return new Label("🚫 Occlusion Blocker") { pickingMode = PickingMode.Ignore };
        }
    }
}
